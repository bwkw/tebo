  ...
  return (
    <>
      <div className='flex items-center justify-center p-5'>
        <div className='w-5/6 overflow-hidden rounded-2xl bg-gray-100 text-gray-500 shadow-xl'>
          <div className='w-full md:flex'>
            <div className='hidden w-1/2 bg-indigo-500 p-10 md:block'>
              <Image src='/images/create.png' alt='logo' width='1000px' height='1200px' />
            </div>
              ...
              <div className='mb-10 text-center'>
                ...
                <div className='-mx-3 flex'>
                  <div className='my-14 w-full px-3'>
                    <label className='px-1 text-xs font-semibold'>Title</label>
                    <div className='flex'>
                ...
                <div className='-mx-3 flex'>
                  <div className='mb-10 w-full px-3'>
                    ...
                    <div className='flex'>
                      ...
                      <textarea
                        className='-ml-10 h-40 w-full resize rounded-lg border-2 border-gray-200 py-2 pl-10 pr-3 outline-none focus:border-indigo-500'
                ...
                <div className='-mx-3 flex'>
                  <div className='mt-10 w-full px-3'>
                    <button className='mx-auto block w-full max-w-xs rounded-lg bg-indigo-500 p-3 font-semibold text-white hover:bg-indigo-700 focus:bg-indigo-700'>
                      REGISTER NOW
                    </button>
                  </div>
                </div>
